...
export REDDR_PROCESSOR_SELECTOR_URL=${REDDR_PROCESSOR_SELECTOR_URL-http://www.perdu.com}
export REDDR_PROCESSOR_SELECTOR_REGEXP=${REDDR_PROCESSOR_SELECTOR_REGEXP-%s+p%a+}
export REDDR_ADD_HEADER_NAME=${REDDR_ADD_HEADER_NAME-Sling-Processor-Role}
...
REDDR_PROCESSOR_SELECTOR_URL='${REDDR_PROCESSOR_SELECTOR_URL}'
REDDR_PROCESSOR_SELECTOR_REGEXP='${REDDR_PROCESSOR_SELECTOR_REGEXP}'
